...
from model.dino_wo_operator_evolution import DINO_wo_OperatorEvolution
from model.dino_wo_multiscale_projection import DINO_wo_MultiScaleProjection
from model.dino_differential_integral import DifferentialOnlyDINO, IntegralOnlyDINO

model_dict = {
    'DINO': DINO,
    'DINO_wo_OperatorEvolution': DINO_wo_OperatorEvolution,
    'DINO_wo_MultiScaleProjection': DINO_wo_MultiScaleProjection,
    'DifferentialOnlyDINO' : DifferentialOnlyDINO,
    'IntegralOnlyDINO': IntegralOnlyDINO
}
